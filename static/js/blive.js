...
! (function(document, undefined) {
    ...
    SOTool = {
        ...
        getPlugin: function(a, b) {
            ...
            window.CloudSdkPlugin && "undefined" != typeof window.CloudSdkPlugin[a] ? b(window.CloudSdkPlugin[a]) : videoSdkTool.getJS(SOTool.PluginStack[a],
            function() {
    ...
    var videoSdkTool = function() {
        function a(b) {
            ...
            },
            {
                ...
                var k = a[d];
                k.test.test(b) && (k.hasOwnProperty("no") ? k.no.test(b) || (c = k.name) : c = k.name)
            }
            return c
        }
        function b(b) {
            ...
            if (a) {
                ...
                if ( - 1 < b.indexOf("windows nt 5.1") || -1 < b.indexOf("windows XP")) return "winXP";
        ...
        return {
                ...
                if ("" == d.device) {
                    ...
                    a: {
                        ...
                        for (var a = 0; a < b.length; a++) {
                            var g = b[a];
                            if (g.test.test(c)) { (!g.hasOwnProperty("no") || g.no.test(c)) && g.hasOwnProperty("test1") && g.test1.test(c);
                                b = g.name;
                                break a
                            }
                        }
            ...
            getJSONbyAjax: function(b, a, c, d, k, n) {
                var s = this.now(),
                l = 0,
                q = this,
                r = -1,
            ...
            objectParseToString: function(b) {
                ...
                c = 0,
                d;
                for (d in b) a = 0 < c ? a + ("&" + d + "=" + b[d]) : a + (d + "=" + b[d]),
                c++;
                return a
            },
            ...
            clone: function(b) {
                ...
                if (b instanceof Array) for (a = [], c = 0, d = b.length; c < d; c++) a[c] = "object" == typeof b[c] && null != b[c] ? arguments.callee(b[c]) : b[c];
                else for (c in a = {},
                b) a[c] = "object" == typeof b[c] && null != b[c] ? arguments.callee(b[c]) : b[c];
                return a
            },
            isHttps: function() {
                try {
    ...
    var BaseCode = {
        decode: function(a) {
            ...
            c = d >> 8 & 255,
            d &= 255,
            64 == e ? k[h++] = String.fromCharCode(b) : 64 == f ? k[h++] = String.fromCharCode(b, c) : k[h++] = String.fromCharCode(b, c, d);
            while (g < a.length);
            return e = k.join("")
        },
        encode: function(a) {
            ...
            d = e >> 6 & 63,
            e &= 63,
            h[g++] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(b) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(c) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(d) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(e);
            while (f < a.length);
            h = h.join("");
            switch (a.length % 3) {
            case 1:
    ...
    UiTool = {
        ...
        drag: function(a, b) {
            ...
            a["on" + d] = function(d) {
                ...
                function n(d) {
                    d || (d = window.event);
                    c ? (d = d.touches.item(0), h = d.pageX - q, k = d.pageY - r) : (h = d.pageX ? d.pageX - q: d.clientX + document.body.scrollLeft - q, k = d.pageY ? d.pageY - r: d.clientY + document.body.scrollTop - r);
                    h = t.x + h;
                    k = t.x + k;
        ...
        return {
            log: function(c, d, e) {
                ...
                if (a != c) try {
                    ...
                    1E3 < b.length && b.shift(); ( - 1 != window.location.href.indexOf("#dSDK=1") || "file" == window.location.href.substr(0, 4).toLocaleLowerCase()) && window.console && window.console.log(c, d, e, g);
    ...
    var FlashPlayer = {
        ...
        create: function(a, b, c) {
            ...
            if (this.check(e.version)) {
                if (this.isEmdbed) for (f in c = ["<embed name='" + d + "'src='" + e.url + "' pluginspage='http://www.macromedia.com/go/getflashplayer' type='application/x-shockwave-flash' width='" + e.width + "' height='" + e.height + "' ", " />"], b = "", e)"width" != f && "height" != f && "url" != f && (b += f + "='" + e[f] + "' ");
                else for (f in b = "", c = ["<object id='" + d + "' classid='clsid:d27cdb6e-ae6d-11cf-96b8-444553540000'codebase='http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,45,0' type='application/x-shockwave-flash' width='" + e.width + "' height='" + e.height + "'><param name='movie' value='" + e.url + "'/>", "</object>"], e)"width" != f && "height" != f && "url" != f && (b += "<param name='" + f + "' value='" + e[f] + "'/>");
                b = c.join(b)
    ...
    ClassTool = function() {
        ...
        return {
            ...
            provideClass: function(b, a) {
                var d = b.split(".");
                if (1 < d.length) for (var e = 0; e < d.length - 1; e++) {
                    var f = d[e];
            ...
            importClass: function(b) {
                for (var c = b.split("."), d = a, e = 0; e < c.length - 1; e++) {
                    var f = c[e];
                    if (!d.hasOwnProperty(f)) throw "the " + b + "--" + f + " class is not provide";
                    d = d[f]
                }
                return d
            }
    ...
    ClassObject = function() {
        ...
        a.prototype = {
            ...
            addEventListener: function(b, a, d) {
                if ("undefined" == typeof b) throw this.log(b),
            ...
            hasEventListener: function(b, a, d) {
                ...
                if ("undefined" == typeof d) throw this.log(d),
                Error("handlerThis is undefined");
                if (this.hasOwnProperty("EventMap") && this.EventMap.hasOwnProperty(b)) for (var e = 0; e < this.EventMap[b].length; e++) {
                    var f = this.EventMap[b][e];
                    if (f.fun == a && f.target == d) return ! 0
                }
                return ! 1
            },
            ...
            removeEventListener: function(b, a, d) {
                this.hasOwnProperty("EventMap") || (this.EventMap = {});
                if (this.EventMap.hasOwnProperty(b)) for (var e = 0; e < this.EventMap[b].length; e++) if (this.EventMap[b][e].fun == a && this.EventMap[b][e].target == d) {
    ...
    Proxy = function() {
        ...
        a.prototype.load = function(b) {
            ...
            this.log("requestUrls:" + jsonTool.jsonToString(b));
        ...
        a.prototype.loadCmp = function(b, a) { ! this.isClose && this.dispatchEvent(new Event(LoadEvent.LOADCMP, [b, a]))
        };
        a.prototype.loadError = function(b, a) { ! this.isClose && this.dispatchEvent(new Event(LoadEvent.LOADERROR, [b, a]))
        };
        return a
    } (),
    Plugin = function() {
        ...
        a.prototype.initPlugin = function(b, a, d) {
            this.pluginCmpFun = a;
            this.REConf = d;
            if (this.REConf.hasOwnProperty(b.type)) if (a = this.REConf[b.type], a.hasOwnProperty("check")) if ("function" == typeof a.check) if (a.check()) this.load(b);
    ...
    View = function() {
        ...
        a.prototype.setUp = function(b, a) {
            ...
            if (a) for (var e = 0; e < d.length; e++) this.el[d[e]] = new DisplayObject(this.el[d[e]]);
    ...
    DisplayObject = function() {
        ...
        a.prototype.hasAttribute = function(b) {
        ...
        a.prototype.removeAttribute = function(b) {
            if (videoSdkTool.isArray(b)) for (var a = 0; a < b.length; a++) this.el.removeAttribute(b[a]);
        ...
        a.prototype = {
            load: function(b, a, d, e) {
                ...
                k = function() {
                    ...
                    videoSdkTool.getJSON(f.urlList[0].url,
                    function(b, d) {
                        g += d.retryCount;
                        a && a.call(e, b, {
                    ...
                    function(b, a) {
                        1 < f.urlList.length ? (g += maxCount, f.urlList.shift(), f.delayID = setTimeout(k, retryTime)) : (g += a.retryCount, d && d.call(e, null, {
                            responseTime: videoSdkTool.now() - h,
                            retryCount: g
                        }))
                    },
            ...
            load2: function(b, a, d, e) {
                ...
                k = function() {
                    clearTimeout(f.delayID);
                    videoSdkTool.getJSONbyAjax(f.urlList[0].url,
                    function(b, d) {
                        g += d.retryCount;
                        a && a.call(e, b, {
                            responseTime: videoSdkTool.now() - h,
    ...
    Timer = function() {
        ...
        a.prototype = {
            ...
            checkTime: function(b) {
                var a = this;
                clearTimeout(this.T);
                if (b && (a.currentCount++, a.timerHandler.call(a.handlerThis), 0 < a.max && a.currentCount >= a.max)) {
                    a.stop();
                    return
                }
        ...
        f.prototype = {
            init: function(b) {
                ...
                case "sdk":
                    ...
                    delete b.ptype;
                    for (var a = "autoplay uu vu liveId streamId activityId".split(" "), c = 0; c < a.length; c++) {
                        var d = a[c];
                        b.hasOwnProperty(d) && (this.config[d] = b[d], delete b[d])
                    }
                    this.systemData.refresh(b);
                    logTool.log("[Stat K]  model init:" + this.systemData.deviceId + "  _2016-02-25 10:43:27.325");
            ...
            videoInfo: function() {
                ...
                case "sdk":
                    ...
                    return b;
                case "html5":
                    return b = this.api.getVideoInfo(),
                    this.videoSetting.refresh(b),
                    b
                }
            },
    ...
    ActiveIdProxy = function() {
        ...
        ClassTool.inherits(a, Proxy);
        a.prototype.getRequestList = function() {
            for (var a = [], d = "http://api.live.letvcloud.com/rtmp/getActivityInfoForPlayer?ver=v4&keyType=1", e = ["activityId", "domain"], f = 0; f < e.length; f++) {
                var g = e[f];
        ...
        a.prototype.loadCmp = function(b, a) {
            if (!this.isClose) {
                ...
                var e = this.model,
                f = {};
                f.activityId = b.activityId;
                f.title = b.activityName;
                f.isdrm = 0;
                f.ark = b.ark;
                f.hasAd = b.isNeedAd;
                f.pic = b.coverImgUrl;
                "http" != f.pic.substr(0, 4) && (f.pic = "");
                for (var g = 0; g < b.lives.length; g++) {
                    var h = b.lives[g];
                    if (1 == h.status || 3 == h.status) {
                        f.liveId = h.liveId;
                        break
                    }
                }
                ...
                f.hasOwnProperty("liveId") && "" != f.liveId ? (e.videoSetting.refresh(f), this.dispatchEvent(new Event(LoadEvent.LOADCMP, [b, a]))) : (e = b.lives[0], f = {
                    code: ERR.INTERRUPT
                },
                0 == e.status ? f = {
                    code: ERR.NOSTART
                    ...
                    code: ERR.END
                }), f.message = liveInfoMap[e.status], f.errInfo = "url:" + this.getUrl() + " respponse:" + jsonTool.jsonToString(b), this.dispatchEvent(new Event(LoadEvent.LOADERROR, [f, a])))
            }
        };
    ...
    LiveIdProxy = function() {
        ...
        ClassTool.inherits(a, Proxy);
        a.prototype.getRequestList = function() {
            for (var a = [], d = "http://api.live.letvcloud.com/v3/rtmp/rtmplive/playInfo?playType=2&keyType=1", e = ["liveId", "domain"], f = 0; f < e.length; f++) {
                var g = e[f];
                this.model.config.hasOwnProperty(g) ? d = "domain" == g ? d + ("&key=" + this.model.config[g]) : d + ("&" + g + "=" + this.model.config[g]) : this.model.videoSetting.hasOwnProperty(g) && (d += "&" + g + "=" + this.model.videoSetting[g])
            }
            d += "&clientType=4";
        ...
        a.prototype.loadCmp = function(b, a) {
            if (!this.isClose) {
                ...
                for (var g = {},
                h = !1,
                k = 0; k < b.streams.length; k++) {
                    var n = b.streams[k];
                    if (0 < n.streamState) {
                        g.hasOwnProperty(n.rateType) || (g[n.rateType] = {},
                        g[n.rateType].videoWidth = n.width, g[n.rateType].videoHeight = n.height, g[n.rateType].sid = n.streamId, g[n.rateType].definition = getDNameByCode(n.rateType), g[n.rateType].vtype = n.rateType, g[n.rateType].urls = []);
                        e.liveback = !1;
    ...
    ActStatusProxy = function() {
        ...
        ClassTool.inherits(a, Proxy);
        a.prototype.getRequestList = function() {
            for (var a = [], d = "http://api.live.letvcloud.com/rtmp/getActivityStatus?ver=v4", e = ["activityId", "liveId", "streamId"], f = 0; f < e.length; f++) {
                var g = e[f];
    ...
    GslbProxy = function() {
        ...
        a.prototype.checkGslbUrl = function(b) {
            ...
            "mp4" == this.model.vodPlayType && -1 == b.indexOf("&tss=no&") && (b = -1 != b.indexOf("&tss=ios&") ? b.replace("&tss=ios&", "&tss=no&") : b + "&tss=no");
            return b
        };
        a.prototype.loadCmp = function(b, a) {
            if (!this.isClose) if (this.log("gslb data:" + jsonTool.jsonToString(b) + " time" + jsonTool.jsonToString(a)), 200 == b.status) {
                b.ercode = "0";
        ...
        b.prototype = {
            ...
            onStateChanged: function(b, a) {
                ...
                case "seek":
                    ...
                    break;
                case "pause":
                    this.reportParam.state != b && this.reportParam.isStartPlay && (this.pausePtStat(), this.sendPlayStat("pa"));
                    break;
                case "resume":
                ...
                case "error":
                    this.reportParam.isStartPlay = !1,
                    this.sendErrorStat(a),
                    null != this.heartTimer && this.heartTimer.stop()
                }
                this.reportParam.state = b
            },
            startHeartTimer: function() {
                this.heartTimer ? this.heartTimer.running || (this.setDelay(), this.heartTimer.start()) : (this.heartTimer = new Timer(18E4, this, this.heartHanlder), this.setDelay(), this.heartTimer.start())
            },
            ...
            sendEnvStat: function() {
                ...
                b += "&xh=" + encodeURIComponent(a.systemData.xh);
            ...
            sendPlayStat: function(b, a) {
                ...
                "play" == b && (c += "&pay=0", a && a.hasOwnProperty("cv") && (c += "&stc=" + encodeURIComponent(videoSdkTool.objectParseToString(a.cv.stc)), c += "&joint=" + a.cv.joint));
                c += "&prl=0";
            ...
            sendErrorStat: function(b) {
                ...
                "live" == c.playType && (a += "&lid=" + c.videoSetting.lid, a += "&sid=" + c.videoSetting.sid);
                b = {
                    ch: c.getTypeFrom(),
    ...
    LiveModel = function() {
        ...
        a.prototype.requestDataByStreamId = function(b) {
        ...
        a.prototype.requestHttpDNS = function(b) {
            ...
            b.addEventListener(LoadEvent.LOADCMP, this.onDNSCmp, this);
        ...
        a.prototype.activeCmp = function(b) {
        ...
        a.prototype.refreshUrlsData = function() {
            ...
            if (!this.isComplete) {
                ...
                if ("" != b["r.gslb.lecloud.com"]) for (var a in this.model.videoSetting.media) {
                    for (var d = [], e = 0; e < this.model.videoSetting.media[a].urls.length; e++) for (var f = 0; f < b["r.gslb.lecloud.com"].length; f++) {
    ...
    BasePlayer = function() {
        ...
        a.prototype.onPlayEmptyHandler = function() {
            ...
            b.startPlay && 3 != b.playState && (5 != b.playState ? (b.playState = 3, b.emptyST = setTimeout(function() {
                b.dispatchEvent(new Event(MediaEvent.EVENT, MediaEvent.BUFFEREMPTY, b.getTime()))
            },
        ...
        a.prototype.onPlayIngHandler = function() {
            var b = this.getTime();
            if (0 <= b && !this.isFtc) if (0 < b) this.log("\u7b2c\u4e00\u6b21\u83b7\u5f97\u975e0\u7684\u64ad\u653e\u65f6\u95f4" + b),
            this.isFtc = !0,
            this.onPlayFullHandler();
            else if ("iphone" == videoSdkTool.getDevice() && "qq" == videoSdkTool.getBrowser()) this.onPlayFullHandler();
            this.startPlay && this.dispatchEvent(new Event(MediaEvent.EVENT, MediaEvent.PLAYING, b))
        };
    ...
    H5SamplePlayer = function() {
        ...
        a.prototype.setUp = function(a, c) {
            ...
            g = '<div id="v{id}" style="left:0px;top:0px;width:100%;height:100%;display: block;position: relative;"><video  id="{id}" controls="controls"  style="width:100%;height:100%;"></video></div>'.replace(/{id}/g, f);
            c.innerHTML = g;
            this.outEl = c;
        ...
        a.prototype.setSize = function() {
            if (!this.config.dvideoSize && this.isShow && 0 < this.videoWidth && 0 < this.videoHeight) {
                var b, a;
                this.videoWidth / this.videoHeight > this.outEl.offsetWidth / this.outEl.offsetHeight ? (b = this.outEl.offsetWidth, a = this.videoHeight * this.outEl.offsetWidth / this.videoWidth) : (a = this.outEl.offsetHeight, b = this.videoWidth * this.outEl.offsetHeight / this.videoHeight);
        ...
        a.prototype.removeEvents = function() {
            for (var b = this.video,
            a = 0; a < c.length; a++) b.removeEventListener(c[a], this.videoHandlerBack, !0)
        };
        a.prototype.videoHandler = function(b) {
            ...
            case "error":
                ...
                this.video.error && this.video.error.hasOwnProperty("code") && (b.code = "49" + this.video.error.code);
                this.errorHandler(b);
                break;
            case "playing":
        ...
        a.prototype.getLoadPercent = function() {
            for (var b = this.video.buffered,
            a = 0; a < b.length; a++) if (this.getTime() < b.end(a)) return Math.min(1, b.end(a) / this.video.duration);
            return 0
        };
        a.prototype.play = function(b, a, c, g) {
            ...
            this.render.init({
                ...
                onstart: function() {
                    ...
                    h.addEvents();
                    h.video.src = h.url;
                    if (h.autoplay || c) h.video.load && h.video.load(),
                    h.video.play()
                },
                onerror: function(b) {
                    h.log("\u6e32\u67d3\u5f15\u64ce\u521d\u59cb\u5316\u5931\u8d25");
    ...
    MediaPlayer = function() {
        ...
        a.prototype.setUp = function(b, a) {
            ...
            for (var f = 0; f < e.length; f++) {
                var g = e[f]; ! d.hasOwnProperty(g) && b.hasOwnProperty(g) && (d[g] = b[g])
            }
    ...
    ControlBarView = function() {
        ...
        a.prototype.setUp = function(b) {
            ...
            this.el.definitionList.addEventListener("mouseover",
            function(b) {
                "touchstart" != b.type && a.definitionListShow.apply(a, arguments)
            });
            this.el.definition.addEventListener("mouseout",
            function() {
                a.definitionListHide.apply(a, arguments)
            });
            this.el.definitionList.addEventListener("mouseout",
            function() {
                a.definitionListHide.apply(a, arguments)
            });
            ...
            this.el.playIngBar.addEventListener("click",
            function(b) {
        ...
        a.prototype.seekHanler = function(b) {
            var a;
            this.playRate = (0.5 * this.el.playBarIco.getWidth() + this.el.playBarIco.getX()) / this.el.playIngBar.getWidth();
        ...
        a.prototype.setSize = function(b, a, d) {
            ...
            this.el.playIngBar.setWidth(b - d)
        };
        a.prototype.skinAction = function(b, a) {
            ...
            case SkinAction.TIME:
                "live" == this.model.playType && this.model.liveback && this.el.playIngBar.setVisible(!0);
                this.playRate = a / this.duration;
                this.isSeeking || (this.el.playBar.setWidth(100 * this.playRate + "%"), this.el.playBarIco.setX(100 * this.playRate + "%"), this.el.time.html(videoSdkTool.num2Time(a)));
                break;
            ...
            case SkinAction.CHANGESTATEPLAY:
                ...
                case PlayState.PAUSE:
                    this.el.playBtn.setVisible(!0),
                    this.el.pauseBtn.setVisible(!1)
                }
                break;
        ...
        a.prototype.setUpControlbarLogo = function(b) {
            ...
            if ("" != a.logoInfo.pic) {
                ...
                "" != a.logoInfo.url ? (d = UiTool.$C("A"), d.href = a.logoInfo.url, d.target = "_blank", d.style.display = "block", d.appendChild(e)) : d = e;
                e.onload = function() {
    ...
    ErrorView = function() {
        ...
        a.prototype.skinAction = function(b, a) {
            ...
            case SkinAction.ERROR:
                ...
                d = 0.5 * (this.el.offsetHeight - (this.el.message.getHeight() + this.el.errCode.getHeight()));
                this.el.message.setY(d);
                this.el.errCode.setY(d + this.el.message.getHeight());
                break;
            case SkinAction.ERRORHIDE:
                this.skin.setVisible(!1),
                this.el.message.html(""),
                this.el.errCode.html("")
            }
        };
        return a
    } (),
    LoadingView = function() {
        ...
        a.prototype.setSize = function(b, a, d) {
            if (this.loading) {
                if (this.loading.getWidth() > b || this.loading.getHeight() > a) d = this.loading.getWidth() / this.loading.getHeight(),
                this.loading.getWidth() / this.loading.getHeight() > b / a ? (this.loading.setWidth(parseInt(b)), this.loading.setHeight(parseInt(b / d))) : (this.loading.setHeight(parseInt(a)), this.loading.setWidth(parseInt(a * d)));
        ...
        a.prototype.skinAction = function(b, a, d) {
            ...
            case SkinAction.LOADING:
                var e = this;
                if (a.show) {
                    if (a.hasOwnProperty("type") && 0 == a.type || "" == a.url) e.el.bld.setVisible(!1),
                    e.el.sld.setVisible(!0);
    ...
    PlayUrlProxy = function() {
        ...
        a.prototype.leUrlsHandler = function(b) {
    ...
    AdCtrl = function() {
        ...
        b.prototype.setUp = function(b, a) {
            ...
            c.player = b;
            c.videoOutEl = a;
            if (c.model.config.hasOwnProperty("onPlayerReady")) if ("function" != typeof c.model.config.onPlayerReady && (c.model.config.onPlayerReady = window[c.model.config.onPlayerReady]), "function" == typeof c.model.config.onPlayerReady) try {
        ...
        b.prototype.startLeAd = function() {
            this.checkAd() ? "undefined" == typeof H5AD || "function" != typeof H5AD.initAD ? videoSdkTool.getJS(c, this.initAd, this.initAd, this, "utf-8") : this.initAd() : this.facade.dispatchEvent(new Event(AdEvent.EVENT, AdEvent.NOAD, "skip"))
        };
        ...
        b.prototype.initAd = function(c, e) {
            ...
            b.prototype.playAD = function() {
                if (this.curAdIndex < this.adList.length) {
                    ...
                    var b = !0;
                    0 == this.curAdIndex && -2 == this.model.config.posterType && (b = "1" == this.model.config.autoplay);
            ...
            b.prototype.getVideoRect = function() {
                return this.player ? this.player.getVideoRect() : {
                    w: 0,
                    h: 0
                }
            };
    ...
    SkinPlayer = function() {
        ...
        a.prototype.setUp = function(b, a, d) {
            b = '<div id="#{video}" style="left:0px;top:0px;position: absolute;width:{width};height:{height};z-index:1;display: block;background-color: #000000;overflow:hidden"></div><div id="#{skin}" style="left:0px;top:0px;position: relative;width:{width};height:{height};z-index:2;overflow: hidden;"></div><div id="#{error}" style="left:0px;top:0px;position: absolute;width:{width};height:{height};z-index:3;overflow: hidden;display:none;"></div>'.replace(/{width}/g, "100%");
        ...
        a.prototype.setStylebyConfig = function(b) {
            ...
            this.el.className = d;
            for (var e = 0; e < a.length; e++) if (!b[a[e]]) if (b.pageControls) SkinRender["setMedia" + a[e]]("", !1);
        ...
        a.prototype.autoSize = function() {
            ...
            case "2":
                ...
                0 == a && (a = UiTool.$E(this.outEl).style.height, a = -1 == a.indexOf("%") ? parseInt(a) : 0),
                0 < a && (this.model.config.changeParent && (this.outEl.style.width = a * b + "px"), this.el.style.width = a * b + "px")
            }
        };
        a.prototype.setSize = function() {
            this.skinView && this.skinView.setSize()
        };
        a.prototype.addEvents = function() {
            this.skinView && (this.hideFun = videoSdkTool.bindFun(this.autoHide, this), this.showFun = videoSdkTool.bindFun(this.autoShow, this), this.skinView.skin.addEventListener("mouseout", this.hideFun), this.skinView.skin.addEventListener("mouseover", this.showFun))
        };
        a.prototype.removeEvents = function() {
        ...
        a.prototype.shutDown = function() {
            this.skinView && (this.skinView.skinAction(SkinAction.BUFFER, 0), this.skinView.skinAction(SkinAction.TIME, 0), this.skinView.skinAction(SkinAction.LOADING, {
                show: !1
        ...
        a.prototype.videoSateHandler = function(b) {
            ...
            case MediaEvent.METADATA:
                this.skinView.skinAction(SkinAction.DURATION, b.args[2]);
                break;
    ...
    VideoPlayer = function() {
        ...
        a.prototype.getConfig = function(b) {
        ...
        a.prototype.changeVideoInfo = function(b) {
            ...
            this.model.videoSetting.hasOwnProperty("liveId") && (b.liveid = this.model.videoSetting.liveId, this.videoInfo.lid = this.model.videoSetting.liveId);
        ...
        a.prototype.showPoster = function(a) {
            ...
            if ( - 2 == this.model.config.posterType) this.mediaPlayer.setPoster(this.model.videoSetting.pic),
            this.facade.dispatchEvent(new Event(PlayerEvent.EVENT, PlayerEvent.VIDEO_AUTH_VALID));
            else if (this.model.config.skinnable || this.model.config.controls) c.playBtn = UiTool.$C("DIV"),
            c.playBtn.style.cssText = "position:absolute;width:75px;height:75px;left:50%;top:50%;background:rgba(1, 1, 1, 0) url(http://yuntv.letv.com/assets/img/skin.png?v=1901) no-repeat -111px -101px;margin: -40px 0 0 -38px;z-index:2;cursor:pointer;",
            c.el.appendChild(c.playBtn),
            UiTool.addEvent(c.playBtn, "click",
            function(a) {
                c.startAuth.call(c)
            })
        };
        ...
        a.prototype.gslbCmp = function(a) {
            ...
            var c = !0;
            0 != this.model.joint || this.isStartPlay || -2 != this.model.config.posterType || (c = "1" == this.model.config.autoplay);
            if (this.model.config.onlyPic) {
                var d = this;
                d.mediaPlayer.show();
                setTimeout(function() {
                    d.mediaPlayer.startPlay(d.videoInfo, d.gslbplayTime, c, d.getPlayerType())
                },
                10)
            } else this.mediaPlayer.startPlay(this.videoInfo, this.gslbplayTime, c, this.getPlayerType());
            this.facade.dispatchEvent(new Event(PlayerEvent.EVENT, PlayerEvent.GSLB_CMP))
        };
    ...
    GlobalPlayer = function() {
        ...
        a.prototype.fullChange = function() {
            this.model.videoSetting && (this.model.videoSetting.fullscreen = UiTool.isFullScreen(), this.model.videoSetting.fullscreen || this.cancelFullscreen(), this.facade.dispatchEvent(new Event(PlayerEvent.EVENT, PlayerEvent.FULLSCREEN)))
        };
        a.prototype.resize = function() {
            this.player.skinplugin && this.player.skinplugin.setSize();
            this.player.videoplugin && this.player.videoplugin.setSize()
        };
        ...
        a.prototype.addVideoEvents = function(a) {
            ...
            function() {
                ...
                c.facade.dispatchEvent(new Event(PlayerEvent.EVENT, PlayerEvent.FULLSCREEN))
    ...
    Api = function() {
        function a(a, c, d) {
            if ("undefined" == typeof d.api[a]) throw Error(a + "is not apply");
            c[a] = function() {
    ...
    FlashSdk = function() {
        ...
        a.prototype.getVideoSetting = function() {
            return this.player.plugin.getVideoSetting()
        };
        a.prototype.getVideoTime = function() {
            return this.player.plugin.getVideoTime()
        };
        a.prototype.pauseVideo = function() {
            this.player.plugin.pauseVideo()
        };
        a.prototype.resumeVideo = function() {
            this.player.plugin.resumeVideo()
        };
        a.prototype.seekTo = function(a) {
            this.player.plugin.seekTo(a)
        };
        a.prototype.replayVideo = function() {
            this.player.plugin.replayVideo()
        };
        a.prototype.closeVideo = function() {
            this.player.plugin.closeVideo()
        };
        a.prototype.setVolume = function(a) {
            this.player.plugin.setVolume(a)
        };
        a.prototype.shutDown = function() {
            this.player.plugin.shutDown()
        };
        a.prototype.startUp = function() {
            this.player.plugin.startUp()
        };
        a.prototype.getBufferPercent = function() {
            return this.player.plugin.getBufferPercent()
        };
        a.prototype.setDefinition = function(a) {
            this.player.plugin.setDefinition(a)
        };
        a.prototype.getDefinition = function() {
            return this.player.plugin.getDefinition()
        };
        a.prototype.getDefaultDefinition = function() {
            return this.player.plugin.getDefaultDefinition()
        };
        a.prototype.getDefinitionList = function() {
            return this.player.plugin.getDefinitionList()
        };
        a.prototype.setVideoPercent = function(a) {
            this.player.plugin.setVideoPercent(a)
        };
        a.prototype.getVideoPercent = function() {
            return this.player.plugin.getVideoPercent()
        };
        a.prototype.setVideoScale = function(a) {
            this.player.plugin.getVideoPercent(a)
        };
        a.prototype.getVideoScale = function() {
            return this.player.plugin.getVideoScale()
        };
        a.prototype.resetVideoScale = function() {
            this.player.plugin.resetVideoScale()
        };
        a.prototype.fullVideoScale = function() {
            this.player.plugin.fullVideoScale()
        };
        a.prototype.setVideoRect = function(a) {
            this.player.plugin.setVideoRect(a)
        };
        a.prototype.getLoadPercent = function() {
            return this.player.plugin.getLoadPercent()
        };
        a.prototype.getDownloadSpeed = function() {
            return this.player.plugin.getDownloadSpeed()
        };
        a.prototype.getPlayRecord = function() {
            return this.player.plugin.getPlayRecord()
        };
        a.prototype.getPlayState = function() {
            return this.player.plugin.getPlayState()
        };
        a.prototype.setVideoColor = function() {
            this.player.plugin.setVideoColor.apply(this, arguments)
        };
        a.prototype.getVideoColor = function() {
            return this.player.plugin.getVideoColor()
        };
        a.prototype.getVersion = function() {
            return this.player.plugin.getVersion()
        };
        a.prototype.setAutoReplay = function(a) {
            this.player.plugin.setAutoReplay(a)
        };
        a.prototype.feedback = function(a) {
            this.player.plugin.feedback(a)
        };
        a.prototype.getLog = function(a) {
            this.player.plugin.getLog(a)
        };
        return a
    } (),
    H5Sdk = function() {
        ...
        configConver: function(a) {
            ...
            case "iphone":
                ...
                default:
                    ...
                    d = [/cpu iphone os 8_/];
                    for (c = 0; c < d.length; c++) if (d[c].test(b)) {
                        a.dvideoSize = !1;
                        break
                    }
                    if (0 <= parseInt(a.posterType) && (d = [/cpu iphone os 7_/, /cpu iphone os 6_/], a.skinnable)) for (c = 0; c < d.length; c++) if (d[c].test(b)) {
                        a.onlyPic = !0;
                        break
                    }
                    break
    ...
    LiveH5Player = function() {
        ...
        a.prototype.init = function() {
            this.superClass.init.apply(this, arguments);
            this.version = "H5_Live_20160225_4.1.7";
        ...
        a.prototype.vStateHandler = function(a) {
            if (!this.model.liveback) switch (a.args[1]) {
            case MediaEvent.PLAYING:
                this.removeCheck();
        ...
        a.prototype.checkHanlder = function(a) {
            ...
            this.lRequest.addEventListener(LoadEvent.LOADCMP, this.checkDataCmp, this);
            this.lRequest.load();
            this.log("\u5f00\u59cb\u8bf7\u6c42\u76f4\u64ad\u72b6\u6001\u63a5\u53e3")
        };
        a.prototype.removeCheck = function() {
            this.lRequest && (this.lRequest.removeEventListener(LoadEvent.LOADCMP, this.checkDataCmp, this), this.liveRequest.unload(), this.liveRequest = null)
        };
        a.prototype.checkDataCmp = function(a) {
