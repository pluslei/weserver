...
var (
	...
	stringRand  = "AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz1234567890"
)
...
func RandomStringSpecLetter(count uint) string {
	return RandomStringSpec0(count, []rune(stringRand))
}
